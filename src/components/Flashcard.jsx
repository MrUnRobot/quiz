      ...
      <div className="max-w-xl mx-auto">
        ...
        <div className="flex gap-6 mt-10">
          <button 
            ...
            className="flex-1 py-5 rounded-2xl font-black text-sm uppercase border-2 border-red-500 text-red-500 active:bg-red-500 active:text-white transition-all outline-none"
          >
          ...
          <button 
            ...
            className="flex-1 py-5 rounded-2xl font-black text-sm uppercase border-2 border-green-500 text-green-500 active:bg-green-500 active:text-white transition-all outline-none"
          >
